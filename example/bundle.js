...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsPureRenderMixin = __webpack_require__(154);
	
	var _VariableText = __webpack_require__(157);
	
	var _VariableText2 = _interopRequireDefault(_VariableText);
	
	var _VariableHeight = __webpack_require__(180);
	
	var _VariableHeight2 = _interopRequireDefault(_VariableHeight);
	
	var _FixedHeight = __webpack_require__(181);
	
	var _FixedHeight2 = _interopRequireDefault(_FixedHeight);
	
	var _SpringConfig = __webpack_require__(182);
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'button',
	          { onClick: function () {
	              return _this.setState({ paragraphs: addText(paragraphs) });
	            } },
	          paragraphs === 4 ? 'Remove text' : 'Add paragraph',
	          ' [',
	          paragraphs,
	          ']'
	        )
	      ...
	      _react2['default'].createElement(
	        _2['default'],
	        { isOpened: isOpened, style: _style.container },
	        _react2['default'].createElement(
	          'div',
	          { style: { padding: 10 } },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HeightReporter = __webpack_require__(177);
	
	var _HeightReporter2 = _interopRequireDefault(_HeightReporter);
	...
	var Collapse = _react2['default'].createClass({
	  ...
	  renderHeightReporter: function renderHeightReporter() {
	    ...
	    var props = _objectWithoutProperties(_props, ['isOpened', 'fixedHeight']);
	
	    return _react2['default'].createElement(_HeightReporter2['default'], _extends({ onHeightReady: this.onHeightReady }, props));
	  },
	  ...
	  renderFixed: function renderFixed() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      function (_ref2) {
	        ...
	        return !isOpened && !height ? null : _react2['default'].createElement(
	          'div',
	  ...
	  render: function render() {
	    ...
	    var props = _objectWithoutProperties(_props3, ['isOpened', 'style', 'children', 'fixedHeight', 'springConfig']);
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        function (st) {
	          _this.height = parseFloat(st.height).toFixed(2);
	          if (!isOpened && !st.height) {
	            return null;
	          }
	
	          var newStyle = _this.height !== parseFloat(height).toFixed(2) ? {
	            height: st.height,
	            overflow: 'hidden'
	          } : { height: 'auto' };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reorderKeys = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _zero = __webpack_require__(169);
	
	var _zero2 = _interopRequireDefault(_zero);
	
	var _updateTree = __webpack_require__(170);
	
	var _deprecatedSprings2 = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stepper = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HeightReporter = _react2['default'].createClass({
	  displayName: 'HeightReporter',
	  ...
	  render: function render() {
	    ...
	    var props = _objectWithoutProperties(_props, ['onHeightReady', 'children']);
	...
	exports['default'] = HeightReporter;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var style = function style(height) {
	  return {
	    content: {
	      height: height,
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        '  Content height:  ',
	        _react2['default'].createElement('input', { type: 'number', step: 50, min: 100, max: 500,
	          value: height, onChange: this.onChange })
	      ),
	      _react2['default'].createElement(
	        _2['default'],
	        { isOpened: isOpened, style: _style.container },
	        _react2['default'].createElement('div', { style: _extends({}, style(height).content, { height: height }) })
	      )
	    );
	  }
	});
	...
	var FixedHeight = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        _2['default'],
	        { isOpened: isOpened, style: _style.container, fixedHeight: collapse },
	        _react2['default'].createElement('div', { style: _extends({}, style(content).content, { height: content }) })
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VariableHeight = _react2['default'].createClass({
	  ...
	  getInitialState: function getInitialState() {
	    var _presets$wobbly = _slicedToArray(_reactMotion.presets.wobbly, 2);
	
	    var stiffness = _presets$wobbly[0];
	    var damping = _presets$wobbly[1];
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        _2['default'],
	        { isOpened: isOpened, style: _style.container, springConfig: [stiffness, damping] },
	        _react2['default'].createElement('div', { style: _extends({}, style(height).content, { height: height }) })
	      )
	    );
	  }
